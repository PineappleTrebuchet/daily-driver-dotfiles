...
-- Status & Tab Line
hi(0, "StatusLine",  { bg = "#191919",  fg = "#aaaaaa" })
...
-- Syntax
hi(0, "Comment",    { fg = "#4444ff",  italic = true })
hi(0, "String",     { fg = "#0000ff" })
hi(0, "Constant",   { fg = "#a64dff" })
